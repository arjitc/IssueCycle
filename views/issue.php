						...
						<div class='float-left'>
							...
							if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
									...
									echo "<a href='download_attachment.php?file_name=$file_name'>$display_name</a> <small><a href='delete_file.php?file_name=$file_name&issue_id=$issue_id'>[Remove]</a></small>";
									echo "<br>";
								}
							}
							?>
